...
`,
  ...
  writeFileSync(
    ...
    `${[
      audit(ago(1), { type: "decision", principal: "owner", surface: "http", urn: "brain.recall", kind: "read", effect: "allow", argsDigest: "sha256:d1" }),
      audit(ago(1), { type: "call", principal: "owner", surface: "http", urn: "brain.recall", argsDigest: "sha256:d1", outcome: "ok", ms: 42 }),
      audit(ago(2), { type: "decision", principal: "owner", surface: "http", urn: "files.delete_everything", kind: "admin", effect: "deny", argsDigest: "sha256:d2" }),
      audit(ago(3), { type: "error", principal: "owner", surface: "http", urn: "brain.note", argsDigest: "sha256:d3", outcome: "MCP error -32001: Request timed out", ms: 40000 }),
      audit(ago(30), { type: "rate_limited", principal: "owner", surface: "http", urn: "-" }),
      audit(ago(9 * 24), { type: "call", principal: "owner", surface: "cli", urn: "ancient.tool", outcome: "ok", ms: 5 }),
